    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <img 
            src="/logo.svg" 
            alt="Virtual Sales Agents" 
            className="h-12 mx-auto mb-4"
          />
          <h1 className="text-2xl font-bold text-gray-900">Get Started</h1>
          <p className="text-gray-600">Create your account and deploy your first avatar</p>
        </div>
            ...
            <form className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-start space-x-2">
                  <input type="checkbox" className="rounded mt-0.5" />
                  <span className="text-sm text-gray-600">
                    I consent to call recording for quality assurance and training purposes
                  </span>
                </label>
              </div>
